...
export default function ContactPage() {
    ...
    return (
        <div className="mb-0 pb-0">
            ...
            <div className="min-h-screen flex lg:flex-row flex-col  items-center justify-between p-6 md:p-5 bg-gradient-to-r from-[#282f44] to-[#634258]  mt-0 pt-0">



                <div className=" mt-5 backdrop-blur-md m-auto  rounded-3xl p-5 max-w-md w-full flex flex-col gap-8 border-2 border-transparent  transition-all duration-300" data-aos="fade-right">
                ...
                <div className={'m-auto mt-5 '} data-aos="fade-left">
                    <Image src={contact} alt={'contact'} width={300} height={200}/>
                </div>
            </div>
        </div>
