...
const About = () => {
    ...
    return (
        <div>
            <div className="min-h-screen max-h-[100%] bg-gradient-to-r from-[#282f44] to-[#634258] pt-20">
                <div className="container mx-auto">
                    ...
                    <div className=" order1 lg:order-2  flex items-center justify-center lg:w-[80%]">
                        ...
                        <h1 className="text-3xl font-bold bg-clip-text text-transparent bg-gradient-to-b from-purple-50 to-violet-500 block lg:hidden pb-10 text-center"><span className="text-slate-300">About</span> Masoumeh</h1>
                            <Image src={ImgSelf} width={400} height={100} alt="img" className=" border-4   w-[300px] md:w-[100%] "/>
                        </div>
                    </div>
                </div>
                    ...
                    <div>
                        ...
                        <div className="mb-10">
                            <div className="border border-[#9ad1aa] text-slate-300 p-2">
                                ...
                                <div className="flex flex-col gap-y-2">
                                    <h1 className="text-xl text-slate-400">Bachelor degree in computer engeneering</h1>
